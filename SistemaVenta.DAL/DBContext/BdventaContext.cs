...
public partial class BdventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C9E9E4905");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__Detalles__BFE2843F530013E2");
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.DetallesVenta)
                ...
                .HasConstraintName("FK__DetallesV__idPro__5441852A");

            entity.HasOne(d => d.IdVentaNavigation).WithMany(p => p.DetallesVenta)
                .HasForeignKey(d => d.IdVenta)
                .HasConstraintName("FK__DetallesV__idVen__534D60F1");
        });

        modelBuilder.Entity<Menu>(entity =>
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483AFBC4315");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4971D6BFE");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A84169118");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132826E94E5");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F766C5FB7CF");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6F1CB9AAA");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__05BB94891DC1F3DB");
